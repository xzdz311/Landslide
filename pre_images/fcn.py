...
def main():
    ...
    model.load_state_dict(torch.load(r'D:\ly\landsint\result\final_FCN_model.pth', map_location=torch.device('cpu')))
    model.eval()
    ...
    results = predict_and_evaluate(
        ...
        device='cpu',
        save_dir=r'D:\ly\landsint\result\predictions_results_fcn',
        multigpu=True
    )
